...
#### Uncomment below 2 lines + lines 139 and 140
#### to print out the operation runtime
...
for x in range(15, -1, -1):
    ...
    for k in range(0, 256):
        ...
        for i in range(0, len(plaintexts)):
            ...
            sbox_result_bit = int(sbox_result_binary[0])

            # Group the timing of the plaintext
            if sbox_result_bit == 1:
                msbit_one.append(runtime)
            elif sbox_result_bit == 0:
